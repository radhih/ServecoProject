...
public class AdvertisementManagment extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3028572716418794681L;
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdvertisementManagment frame = new AdvertisementManagment();
	...
	{this.setVisible(false);
		new AdvertisementManagment().setVisible(true);
	}
	public AdvertisementManagment() {
